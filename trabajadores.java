...
public class trabajadores {
    ...
    public void setTarifa_diaria(int tarifa_diaria) {
     ...
     //Calculos del salario promedio de los trabadores que será heredado por las clases hijas 
    /**
    ...
    /**
     * @return el descuento por las ausencias multiplicado con la tarifa diaria del trabajador 
     */
